          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
            {myBooks.map((userBook, index) => (
              ...
              >
                ...
                <button
                  onClick={(e) => handleDelete(e, userBook.id)} // Passamos o evento 'e'
                  className="absolute top-2 left-2 z-20 text-gray-400 bg-white/90 hover:bg-red-100 hover:text-red-600 rounded-full p-1.5 shadow-md transition-colors"
                    ...
                    userBook.book.pageCount > 0 && (
                      <div className="w-full bg-gray-200 rounded-full h-1.5 mt-3">
                        <div
                          ...
                          style={{
                            width: `${
                              (userBook.pagesRead / userBook.book.pageCount) *
                              100
                            }%`,
                          }}
                        ></div>
